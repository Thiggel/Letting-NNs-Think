...
from .NormalizedQwen2MLP import NormalizedQwen2MLP
from .NormalizedQwen2SdpaAttention import NormalizedQwen2SdpaAttention

logger = logging.get_logger(__name__)


class NormalizedQwen2DecoderLayer(nn.Module, NormalizedDecoderLayer):
    def __init__(
        self,
        config: Qwen2Config,
        layer_idx: int,
        ...
        # Core components
        self.self_attn = NormalizedQwen2SdpaAttention(
            config=config, layer_idx=layer_idx
        )
        self.mlp = NormalizedQwen2MLP(config)
